...
class CElseif implements IBlock
{
    use BlockHandleTrait;

    public const TYPE = 'choice';
    public const ACTION = 'elseif';
    ...
    public function do(array &$blockStorage): bool
    {
        try {
            ...
            throw (new RuntimeException('Logic-Elseif'))->setExceptionKey(self::TYPE, self::ACTION)->setExtraData($this->extra->getData());
        } finally {
