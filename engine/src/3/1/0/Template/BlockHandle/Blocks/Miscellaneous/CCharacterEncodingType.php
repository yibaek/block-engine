...
class CCharacterEncodingType implements IBlock
{
    use BlockHandleTrait;

    public const TYPE = 'miscellaneous';
    public const ACTION = 'character-encoding-type';

    public const ENCODING_TYPE_UTF8 = 'UTF-8';
    public const ENCODING_TYPE_EUCKR = 'EUC-KR';
    ...
    /**
     * CCharacterEncodingType constructor.
