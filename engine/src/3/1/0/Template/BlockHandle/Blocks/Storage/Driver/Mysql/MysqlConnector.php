...
class MysqlConnector implements IBlock
{
    use BlockHandleTrait;

    public const TYPE = 'storage';
    public const ACTION = 'driver-mysql-connect-create';
    ...
    public function do(array &$blockStorage): array
    {
        try {
            ...
            throw (new RuntimeException('Storage-Mysql-Connector'))->setExceptionKey(self::TYPE, self::ACTION)->setExtraData($this->extra->getData());
        }
    }
