...
class ProcedureParam implements IBlock
{
    use BlockHandleTrait;

    public const TYPE = 'storage';
    public const ACTION = 'statement-procedure-param';
    ...
    public function do(array &$blockStorage): array
    {
        try {
            ...
            throw (new RuntimeException('Storage-Procedure-Param'))->setExceptionKey(self::TYPE, self::ACTION)->setExtraData($this->extra->getData());
        }
    }
