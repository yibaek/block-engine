...
class OracleConnector implements IBlock
{
    use BlockHandleTrait;

    public const TYPE = 'storage';
    public const ACTION = 'driver-oracle-connect-create';
    ...
    public function do(array &$blockStorage): array
    {
        try {
            ...
            throw (new RuntimeException('Storage-Oracle-Connector'))->setExceptionKey(self::TYPE, self::ACTION)->setExtraData($this->extra->getData());
        }
    }
    ...
    private function getConnectInfo(array &$blockStorage): array
    {
        ...
        return [
            ...
            'sid' => $connectInfo['storage_sid'],
            'tns' => $connectInfo['storage_tns'] ?? null,
