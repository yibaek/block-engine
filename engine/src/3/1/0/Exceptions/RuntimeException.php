...
class RuntimeException extends SynctreeException implements ISynctreeException
{
    private $data;
    ...
    {
        parent::__construct($this->makeMessage($this, 'RuntimeException: '.$message.': Error occured'), $code, $previous);
    }
