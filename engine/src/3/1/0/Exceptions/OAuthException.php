...
class OAuthException extends SynctreeException implements ISynctreeException
{
    private $data;
    ...
    public function getData(): array
    {
        ...
        unset($this->data['body']['result_data']['error'], $this->data['body']['result_data']['error_description']);

        return array_merge($resData, $this->data['body']['result_data']);
    }
