...
class InvalidArgumentException extends SynctreeException implements ISynctreeException
{
    private $data;
    ...
    {
        parent::__construct($this->makeMessage($this, 'InvalidArgumentException: '.$message), $code, $previous);
    }
