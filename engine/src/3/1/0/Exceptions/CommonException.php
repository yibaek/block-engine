...
class CommonException extends SynctreeException implements ISynctreeException
{
    private $data;
    ...
    {
        parent::__construct($this->makeMessage($this, 'CommonException: '.$message), $code, $previous);
    }
