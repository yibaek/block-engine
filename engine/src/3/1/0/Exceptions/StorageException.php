...
class StorageException extends SynctreeException implements ISynctreeException
{
    private $data;
    ...
    {
        parent::__construct($this->makeMessage($this, 'Storage Exception: '.$message), $code, $previous);
    }
