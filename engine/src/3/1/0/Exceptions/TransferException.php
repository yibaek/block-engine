...
class TransferException extends SynctreeException implements ISynctreeException
{
    private $data;
    ...
    {
        parent::__construct($this->makeMessage($this, 'TransferException: '.$message), $code, $previous);
    }
