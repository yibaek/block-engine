...
class RedisMgr
{
     ...
     */
    public function __construct(LogMessage $logger, array $config = null)
    {
        // load config
        if (empty($config)) {
     ...
     * @throws Throwable
     */
    public function getConnection(int $dbIndex, string $key)
    {
        return $this->makeConnection($key, $dbIndex);
    }
     ...
     * @throws Throwable
     */
    public function makeConnection(string $key, int $dbIndex = 0)
    {
