...
use Ntuple\Synctree\Syrn\Schedule\ScheduleRunBizunit;
use Ntuple\Synctree\Syrn\Bizunit\RunBizunit;
use Ntuple\Synctree\Syrn\Schedule\ConfigurationParser;
...
$container
    ->register(ScheduleRunBizunit::class, ScheduleRunBizunit::class)
    ->setPublic(true)
    ->setArguments(
        [
...
$container
    ->register(RunBizunit::class, RunBizunit::class)
    ->setArguments(
        [
