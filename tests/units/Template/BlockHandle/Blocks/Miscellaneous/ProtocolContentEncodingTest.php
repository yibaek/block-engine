 ...
 * @since SRT-231
 */
class ProtocolContentEncodingTest extends TestCase
{
    /**
     * @test
    ...
    public function block_returns_input_string_directly_as_output($value, $error)
    {
        ...
        $sut = new ProtocolContentEncoding($storage, $extra, $value);
    ...
    {
        foreach (ProtocolContentEncoding::OPTIONS as $option) {
